...
**Status:** ACCEPTED-plan (owner approved 2026-07-01; execution autonomous, pending). Recorded as ADR-0013. Plan: `engineering/KCSI-01-CAPABILITY-EXTRACTION-PLAN.md`. Roadmap: `documentation/CAPABILITY-EVOLUTION-ROADMAP.md`.
