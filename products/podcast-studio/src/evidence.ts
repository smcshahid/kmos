 ...
 * over the transcript Asset KMOS already records as the concept's evidence ref — we
 * surface *where* the idea appears; we never fabricate a quote.
 *
 * KCSI-02: identical to Knowledge Studio's `evidence.ts` — shared-capability candidate.
 */
